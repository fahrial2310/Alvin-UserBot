...
async def img_sampler(event):
    ...
    await event.edit("_Please Wait master, Is Looking For The Image You Are Looking For..._")
...
@register(outgoing=True, pattern="^;tr|gtr(?: |$)(.*)")
async def _(event):
    if event.fwd_from:
        return
...
\nUsage:Translates text to speech for the language which is set.\nUse .lang tts <language code> to set language for tts. (Default is English.)",
        "translate": ";tr|;gtr <text> [or reply]\
